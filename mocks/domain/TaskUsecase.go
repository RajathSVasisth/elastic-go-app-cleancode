...
func (_m *TaskUsecase) Create(c context.Context, task *elastic_go_app_cleancodedomain.Task) error {
...
func (_m *TaskUsecase) FetchByUserID(c context.Context, userID string, pagination elastic_go_app_cleancodedomain.Pagination) ([]elastic_go_app_cleancodedomain.Task, error) {
...
func (_m *TaskUsecase) Update(c context.Context, task *elastic_go_app_cleancodedomain.Task) error {
	ret := _m.Called(c, task)
