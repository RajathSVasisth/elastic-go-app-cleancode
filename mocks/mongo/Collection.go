...
func (_m *Collection) Aggregate(_a0 context.Context, _a1 interface{}) (elastic_go_app_cleancodemongo.Cursor, error) {
	ret := _m.Called(_a0, _a1)

	var r0 elastic_go_app_cleancodemongo.Cursor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) (elastic_go_app_cleancodemongo.Cursor, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) elastic_go_app_cleancodemongo.Cursor); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(elastic_go_app_cleancodemongo.Cursor)
		}
	}
...
func (_m *Collection) Find(_a0 context.Context, _a1 interface{}, _a2 ...*options.FindOptions) (elastic_go_app_cleancodemongo.Cursor, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
	...
	var r0 elastic_go_app_cleancodemongo.Cursor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) (elastic_go_app_cleancodemongo.Cursor, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) elastic_go_app_cleancodemongo.Cursor); ok {
		r0 = rf(_a0, _a1, _a2...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(elastic_go_app_cleancodemongo.Cursor)
...
func (_m *Collection) FindOne(_a0 context.Context, _a1 interface{}) elastic_go_app_cleancodemongo.SingleResult {
	ret := _m.Called(_a0, _a1)

	var r0 elastic_go_app_cleancodemongo.SingleResult
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) elastic_go_app_cleancodemongo.SingleResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(elastic_go_app_cleancodemongo.SingleResult)
		}
	}
