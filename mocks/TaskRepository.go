...
func (_m *TaskRepository) FetchByUserID(c context.Context, userID string, pagination domain.Pagination) ([]domain.Task, error) {
...
func (_m *TaskRepository) Update(c context.Context, task *domain.Task) error {
	ret := _m.Called(c, task)
