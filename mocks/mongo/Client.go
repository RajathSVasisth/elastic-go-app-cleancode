...
func (_m *Client) Database(_a0 string) elastic_go_app_cleancodemongo.Database {
	ret := _m.Called(_a0)

	var r0 elastic_go_app_cleancodemongo.Database
	if rf, ok := ret.Get(0).(func(string) elastic_go_app_cleancodemongo.Database); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(elastic_go_app_cleancodemongo.Database)
		}
	}
